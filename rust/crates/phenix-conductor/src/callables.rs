...
use phenix_core::{
    ...
    FileObservation, LanguageObservation, LanguageServiceConfiguration, OrchestrationDefinition,
    OrchestrationNodeId, OrchestrationValueBinding, SessionId, WorkspaceId,
};
...
pub struct ToolOutcome {
    ...
    pub language_observations: Vec<LanguageObservation>,
}
...
impl ToolOutcome {
    ...
    #[must_use]
    pub fn with_language_observation(mut self, observation: LanguageObservation) -> Self {
