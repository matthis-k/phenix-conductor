fn event_type(event: &DomainEvent) -> &'static str {
    match event {
        ...
        DomainEvent::WorkerTaskCreated { .. } => "worker_task_created",
        DomainEvent::WorkerTaskStarted { .. } => "worker_task_started",
        DomainEvent::WorkerTaskVerificationRequired { .. } => "worker_task_verification_required",
        DomainEvent::WorkerResultRecorded { .. } => "worker_result_recorded",
        DomainEvent::WorkerVerificationRecorded { .. } => "worker_verification_recorded",
        DomainEvent::WorkerFailureAnalysisRecorded { .. } => "worker_failure_analysis_recorded",
        DomainEvent::WorkerTaskCompleted { .. } => "worker_task_completed",
        DomainEvent::WorkerTaskFailed { .. } => "worker_task_failed",
        DomainEvent::TerminalCreated { .. } => "terminal_created",
        DomainEvent::JobCreated { .. } => "job_created",
        DomainEvent::TerminalStateChanged { .. } => "terminal_state_changed",
        DomainEvent::JobStateChanged { .. } => "job_state_changed",
        DomainEvent::JobPromoted { .. } => "job_promoted",
        DomainEvent::TerminalOutputRecorded { .. } => "terminal_output_recorded",
        DomainEvent::JobOutputRecorded { .. } => "job_output_recorded",
