fn event_type(event: &DomainEvent) -> &'static str {
    match event {
        ...
        DomainEvent::DecisionDraftCreated { .. } => "decision_draft_created",
        DomainEvent::DecisionDraftRevised { .. } => "decision_draft_revised",
        DomainEvent::DecisionRecorded { .. } => "decision_recorded",
        DomainEvent::DecisionApplicabilityAssessed { .. } => "decision_applicability_assessed",
