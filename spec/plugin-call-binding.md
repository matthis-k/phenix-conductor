...
Compile-time calls use the concrete target selected at compile time. They retain the same Layer interposition, authority attenuation, cancellation, provenance, and value conversion rules as runtime calls.
